...
<div className="size-8 rounded-full bg-slate-300 overflow-hidden" data-alt="Student profile small avatar" style={{backgroundImage: 'url(\'https'}}></div>
...
<div className="size-32 rounded-2xl border-4 border-white dark:border-slate-900 bg-slate-100 overflow-hidden" data-alt="Professional headshot of a student" style={{backgroundImage: 'url(\'https'}}></div>
<div className="flex-1 mb-2">
<h1 className="text-2xl font-bold text-slate-900 dark:text-white">Alex Chen</h1>
<p className="text-slate-500 font-medium">Computer Science Student at Stanford University</p>
<div className="flex flex-wrap gap-4 mt-2 text-sm text-slate-400">
<span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-sm">location_on</span> Palo Alto, CA</span>
<span className="flex items-center gap-1.5"><span className="material-symbols-outlined text-sm">calendar_today</span> Graduating May 2025</span>
</div>
</div>
<div className="flex gap-3 mb-2">
<button className="px-5 py-2 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors" onClick={(e) => { e.preventDefault(); navigate('/student_profile_page'); }}>Edit Profile</button>
<button className="px-5 py-2 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-primary/90 transition-shadow" onClick={(e) => { e.preventDefault(); navigate('/student_profile_page'); }}>Share Profile</button>
</div>
</div>
</div>
...
<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-6">
                            Passionate software engineering student with a focus on cloud architecture and distributed systems. 
                            Currently seeking a Summer 2024 internship where I can apply my skills in full-stack development 
                            and contribute to scalable products.
                        </p>
<div className="grid grid-cols-2 gap-4 text-sm">
<div>
<p className="text-slate-400 mb-1">Email</p>
<p className="font-medium text-slate-700 dark:text-slate-200">alex.chen@stanford.edu</p>
</div>
<div>
<p className="text-slate-400 mb-1">Phone</p>
<p className="font-medium text-slate-700 dark:text-slate-200">+1 (650) 555-0123</p>
</div>
</div>
</section>
...
<button className="text-primary text-sm font-medium">Add Education</button>
</div>
...
<h4 className="font-bold text-slate-900 dark:text-white">Stanford University</h4>
<p className="text-sm text-slate-500 mb-2">B.S. in Computer Science • 3.92 GPA</p>
...
<div>
<p className="text-xs font-bold truncate max-w-[120px]">Alex_Chen_Resume.pdf</p>
...
<span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">github.com/alexchen-dev</span>
</Link>
<Link className="flex items-center gap-3 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-colors group" to="#">
...
<span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">linkedin.com/in/alexchen</span>
</Link>
</div>
</section>
</div>
