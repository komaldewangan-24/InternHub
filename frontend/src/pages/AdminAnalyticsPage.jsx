    ...
    >
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {analyticTiles.map((tile) => (
          <div key={tile.label} className="group rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 p-8 shadow-sm transition-all hover:border-primary/20">
            <div className={`mb-4 flex size-12 items-center justify-center rounded-2xl bg-slate-50 dark:bg-white/5 ${tile.color} group-hover:scale-110 transition-transform`}>
      ...
      <div className="mt-12 rounded-[3rem] border border-slate-200 dark:border-white/5 bg-white dark:bg-slate-900 p-10">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 w-full lg:w-auto">
            {[
              ...
              <button 
                ...
                className="flex flex-col items-center justify-center rounded-2xl border border-slate-100 dark:border-white/10 bg-slate-50 dark:bg-white/5 p-4 text-center transition-all hover:border-primary hover:bg-primary/5 group"
