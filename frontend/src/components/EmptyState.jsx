...
export default function EmptyState({ title, description, icon = 'inbox_customize' }) {
  return (
    <div className="rounded-[2.5rem] border-2 border-dashed border-slate-200 dark:border-white/5 bg-slate-50/50 dark:bg-white/5 p-12 text-center transition-all hover:border-primary/20">
      <div className="mx-auto flex size-14 items-center justify-center rounded-2xl bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-white/5 mb-6">
