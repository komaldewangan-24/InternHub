...
export default function LoadingState({ label = 'Preparing your experience...' }) {
  return (
    <div className="rounded-xl border border-slate-200 dark:border-white/5 bg-white dark:bg-slate-900 p-16 text-center shadow-lg shadow-black/5 flex flex-col items-center">
